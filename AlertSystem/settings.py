...
SECRET_KEY = '-jqs_#tfdkmr95ggxk&s-mbvgterp8v^@a=py7a_o6d(l31en='
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates'),os.path.join(BASE_DIR,'Alert_App/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/Alert_App/static/'
STATIC_ROOT = os.path.join(BASE_DIR,'Alert_App/static/')
STATICFILES_DIRS = [
